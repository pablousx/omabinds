...
FILES = ['manifest.json','Panel.qml','BarWidget.qml','Model.js','assets','backend','lua','scripts','tests','docs','README.md','LICENSE']


def command(args):
    subprocess.run(args, check=True, env=dict(os.environ, OMARCHY_SHELL_IPC_TIMEOUT='15s'))
